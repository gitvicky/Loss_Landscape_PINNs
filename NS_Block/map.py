...
# models = ['sparse_0.pth', 'sparse_1.pth', 'sparse_5.pth', 'sparse_10.pth', 'coarse_10.pth', 'LineData_NS_Block.pth']
# models = ['sparse_10.pth', 'coarse_10.pth', 'LineData_NS_Block.pth']
models = ['LineData_NS_Block.pth']
...
for ii in range(len(models)):
    ...
    np.save(path + '/loss_maps/Loss_Surface_' + name, losses)
