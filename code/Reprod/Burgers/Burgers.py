...
PINN solving 1D Burgers Equations. Numerical Schemes built using FFT. Sparse regulated Approach and empirical verification by visualising the loss landscape. 
"""
# %%
#Numerical Solver
import numpy as np
...
def Burgers_PINN(sparse_val):
    ...
    torch.save({
        ...
        'loss': loss
    }, results + '/Burgers_'+str(run_id)+'.pth')
...
for ii in range(len(models)):
    ...
    ax.set_title('Loss Landscape for ' + name)
