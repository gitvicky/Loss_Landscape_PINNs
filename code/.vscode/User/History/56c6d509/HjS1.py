...
def Burgers_PINN(sparse_val):
    ...
    torch.save({
        ...
        'loss': loss
    }, path + '/Reprod/Burgers/models/' + 'Burgers_'+str(run_id)+'.pth')
...
for ii in range(len(models)):
    ...
    # Checkpoint
    model_loc = path + '/Reprod/Burgers/models/' + models[ii]
    ...
    np.save(path + 'Reprod/Burgers/loss_landscapes/Loss_Surface_' + name, losses)
